...
export const metadata: Metadata = {
  ...
  description:
    "Les prochaines maraudes, distributions et actions logistiques de Que du Kheir en Seine-Saint-Denis et à Paris. Inscrivez-vous comme bénévole.",
};
                ...
                <div className="rounded-3xl border border-marron/10 bg-cream-soft p-6 shadow-soft sm:p-8">
                  ...
                  <div className="mt-6 flex items-start gap-3 rounded-2xl border border-marron/10 bg-cream p-4">
                    ...
                    <p className="text-sm text-gris">
                      Dates indicatives, à confirmer. Lieux et horaires précis sont communiqués aux
                      bénévoles inscrits, en général via WhatsApp.
                    </p>
                  </div>
                </div>
              </Reveal>
      ...
      <section className="mx-auto max-w-[1400px] px-4 py-16 sm:px-6 sm:py-24">
        <Reveal>
          <div className="grid items-center gap-8 rounded-3xl border border-marron/10 bg-cream-soft p-8 sm:p-12 lg:grid-cols-[1.5fr_1fr]">
            <div>
              <SectionTitle as="h2">Une date vous convient ?</SectionTitle>
              <SectionLede>
                Inscrivez-vous comme bénévole : on note vos disponibilités et on vous recontacte pour
                la prochaine sortie qui colle à votre agenda.
              </SectionLede>
            </div>
